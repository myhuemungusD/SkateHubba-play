...
vi.mock("../services/users", () => {
  ...
  return {
    ...
    // Auth-bootstrap variant used by ProfileSetup to cover the
    // Firestore auth-token propagation race. Shares the "no existing
    // profile" default so new-user flows still render the form.

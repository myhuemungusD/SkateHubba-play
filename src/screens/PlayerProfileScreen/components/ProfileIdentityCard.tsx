      ...
      <div className="relative">
        ...
        {isOwnProfile && uid && (
          <button
            ...
            className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-brand-orange text-white flex items-center justify-center shadow-md focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-orange"
          >
            <svg
              width="14"
              height="14"

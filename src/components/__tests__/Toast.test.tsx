...
describe("Toast", () => {
  ...
  it("renders as a plain (non-live) element — the container owns role=status", () => {
    // See Toast.tsx: this element deliberately carries no ARIA live-region
    // role of its own; ToastContainer's always-mounted wrapper does.
    render(<Toast notification={notification} onDismiss={vi.fn()} />);

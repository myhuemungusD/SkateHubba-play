          ...
          <div className="flex flex-col gap-3">
            ...
            {borderline && (
              <div className="p-3 rounded-xl border border-brand-orange/40 bg-brand-orange/[0.06]">
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <button type="button" disabled={busy} onClick={() => doUpload(true)} className={`flex-1 ${PRIMARY_BTN}`}>
            ...
            {!borderline && (
              <div className="flex gap-2">
                ...
                <button type="button" disabled={busy} onClick={() => doUpload(false)} className={`flex-1 ${PRIMARY_BTN}`}>

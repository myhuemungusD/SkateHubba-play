...
| ------------- | ------------------------------------------------------------- |
| User accounts | Never deleted by design                                       |
| Usernames     | Never deleted — reservations are permanent                    |
| Games         | Never deleted — history preserved for context                 |
| Videos        | Never deleted in the current version (no cleanup implemented) |

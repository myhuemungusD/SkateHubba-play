...
| `setterConfirm`        | `boolean \| null`   | Setter's vote on whether the matcher landed (`null` = not yet voted) |
| `matcherConfirm`       | `boolean \| null`   | Matcher's vote on whether they landed (`null` = not yet voted)       |

# DSA Compliance Tracker — Feb 17 Deadline
...
> **⚠️ TRACKER IS UNMAINTAINED AND PAST ITS OWN DEADLINE.** As of the last docs
> audit (2026-08-29) every item below still reads "Not started", months after the
> February 17 gate. Either this board was never updated as work progressed, or the
> app is out of EU compliance. Nothing in this repository can resolve that —
> someone with access to the Apple and D&B accounts needs to reconcile the real
> status and rewrite this file. Treat the statuses below as **unverified**.

**Hard deadline: February 17** (store-side enforcement — submissions/updates after
